...
public class Scrabble {
	...
	public static String createHand() {
		String randStr = MyString.randomStringOfLetters(HAND_SIZE - 2);
		randStr = MyString.insertRandomly('a', randStr);
		randStr = MyString.insertRandomly('e', randStr);
		return randStr;
	}
	...
	public static void playHand(String hand) {
			...
			if (input.equals(".")) {
				...
				if (input.length() == 0 || input.equals("") || input.length() > hand.length() || !MyString.includeAllLetters(hand, input)) {
					...
					if (!isWordInDictionary(input)) {
						...
						score += tempScore;
						System.out.println(input + " earned " + tempScore + " points. Score: " + score + " points"); // Period fix here!
		...
		if (hand.length() == 0) {
			System.out.println("Ran out of letters. Total score: " + score + " points."); // Period fix here!
		} else {
			System.out.println("End of hand. Total score: " + score + " points."); // Period fix here!
		}
	}
